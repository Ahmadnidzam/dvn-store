...
@section('title', 'Dashboard - DVNStore')
...
<section class="mb-5">
    ...
    @if($games->isEmpty())
        <div class="text-center text-muted py-5">Belum ada game yang tersedia.</div>
    @else
...
<section class="mb-5">
    ...
    @if($apps->isEmpty())
        <div class="text-center text-muted py-5">Belum ada aplikasi yang tersedia.</div>
    @else
        <div class="scroll-container d-flex gap-4 overflow-auto pb-2">
            @foreach ($apps as $app)
            <div class="product-card" style="min-width: 260px;">
